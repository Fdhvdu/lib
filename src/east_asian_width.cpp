...
namespace nTool
{
	bool is_ambiguous(const unsigned long unicode) noexcept
	{
		return
	...
	bool is_fullwidth(const unsigned long unicode) noexcept
	{
		return
	...
	bool is_halfwidth(const unsigned long unicode) noexcept
	{
		return
	...
	bool is_narrow(const unsigned long unicode) noexcept
	{
		return
	...
	bool is_neutral(const unsigned long unicode) noexcept
	{
		return
	...
	bool is_wide(const unsigned long unicode) noexcept
	{
		return
